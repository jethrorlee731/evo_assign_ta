...
DS3500
HW4: An Evolutionary Approach to TA/Lab Assignments (objectives.py)
March 28, 2023

objectives.py - objectives for the framework to evaluate the solutions produced
"""
# import statement
import numpy as np
...
def conflicts(L):
    ...
    Args:
        L (numpy array): a solution in the form of a 2D array with sections as columns and TAs as rows
    Return:
        time_conflicts (int): number of TAs with one or more time conflicts
    """
    ...
    # as a maximum of one conflict based on their schedule)
...
def undersupport(L):
    ...
    Args:
        L (numpy array): a solution in the form of a 2D array with sections as columns and TAs as rows
    Return:
        total_undersupport (int): total undersupport penalty over all labs
    """
